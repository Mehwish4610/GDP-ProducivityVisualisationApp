...
if st.session_state.current_page == "Login":
    ...
    if page == "Home":
        ...
        if filtered_df.empty:
            ...
            fig.update_traces(line=dict(color='#441752'))
            st.plotly_chart(fig)
            ...
            fig_sector = px.bar(
                ...
                color_discrete_sequence=['#A888B5', '#8174A0', '#A888B5']
            )
            ...
            purple_colors_pie = ['#633279', '#8174A0', '#A888B5', '#EFB6C8']
            pie_chart = px.pie(
                values=gdp_contribution,
                names=gdp_contribution.index,
                title="GDP Contribution by Sector",
                color_discrete_sequence=purple_colors_pie
            )
            ...
            st.markdown(
                f"""
                <div style="background-color: #e9deec; padding: 10px; border-radius: 5px; color: #382445;  margin-bottom: 15px;">
            ...
            st.markdown(
                f"""
                <div style="background-color: #e4d2f0; padding: 10px; border-radius: 5px; color: #56376a; margin-bottom: 15px;">
        ...
        st.markdown("""
           ...
           """)
        power_bi_url = "https://app.powerbi.com/view?r=eyJrIjoiNGQ4NTUzZGYtYjU3Yi00MjcxLTgzMzAtMWFjNTM1ZDc3Y2YzIiwidCI6IjJiMjFlNzcxLWYwOTgtNDYwNS04ZWMxLTA2ZWQ1MTkyY2U4ZiJ9&pageName=484b17c26b5f099c5f0d"
